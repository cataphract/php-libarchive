 ...
 * Stub hash: 36cf43d83738bae67de30b38273fb3f3c22b125a */
...
static void register_libarchive_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("libarchive\\ENTRY_TYPE_FILE", AE_IFREG, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("libarchive\\ENTRY_TYPE_DIR", AE_IFDIR, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("libarchive\\ENTRY_TYPE_SYMLINK", AE_IFLNK, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("libarchive\\ENTRY_TYPE_SOCKET", AE_IFSOCK, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("libarchive\\ENTRY_TYPE_CHAR", AE_IFCHR, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("libarchive\\ENTRY_TYPE_BLOCK", AE_IFBLK, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("libarchive\\ENTRY_TYPE_FIFO", AE_IFIFO, CONST_PERSISTENT);
}
